...
public abstract class NIMWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static NIMWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(NIMWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<NIMDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<NIMDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<NIMDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<NIMDbContext, Task<T>> func)
    {
        T result;
